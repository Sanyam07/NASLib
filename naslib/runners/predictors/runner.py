...
supported_predictors = {
    ...
    "fisher": ZeroCostV2(config, batch_size=64, method_type="fisher", use_naslib_graph=True),
    "flops": ZeroCostV2(config, batch_size=64, method_type="flops", use_naslib_graph=True),
    ...
    "grad_norm": ZeroCostV2(config, batch_size=64, method_type="grad_norm", use_naslib_graph=True),
    "grasp": ZeroCostV2(config, batch_size=64, method_type="grasp", use_naslib_graph=True),
    "jacov": ZeroCostV1(config, batch_size=64, method_type="jacov"),
    "jacov2": ZeroCostV2(config, batch_size=64, method_type="jacov", use_naslib_graph=True),
    ...
    "params": ZeroCostV2(config, batch_size=64, method_type="params", use_naslib_graph=True),
    ...
    "seminas": SemiNASPredictor(encoding_type="seminas", semi=True, hpo_wrapper=False, 
                                hparams_from_file=config.hparams_from_file),
    "snip": ZeroCostV2(config, batch_size=64, method_type="snip", use_naslib_graph=True),
    ...
    "synflow": ZeroCostV2(config, batch_size=64, method_type="synflow", use_naslib_graph=True),
